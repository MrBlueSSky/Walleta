...
class PersonalExpenseSheet extends StatefulWidget {
  ...
  const PersonalExpenseSheet({Key? key, required this.userId})
    : super(key: key);

  @override
  State<PersonalExpenseSheet> createState() => _AddPersonalExpenseSheetState();
}

class _AddPersonalExpenseSheetState extends State<PersonalExpenseSheet> {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // Fecha
                              _buildSectionLabel('Fecha del gasto', isDark),
                              const SizedBox(height: 12),
                              GestureDetector(
                      ...
                      Card(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _buildSectionLabel('Monto del gasto', isDark),
                              const SizedBox(height: 16),
  ...
  Widget _buildValidationMessage() {
    ...
    Color getMessageColor() {
      if (paid == 0) return const Color(0xFFF59E0B);
      if (paid < total) return const Color(0xFF2D5BFF);
