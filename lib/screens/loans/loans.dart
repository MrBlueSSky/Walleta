  ...
  void _showRegisterPaymentDialog(LoanData loan, bool isDark) {
    ...
    Future<void> _pickImage() async {
      ...
      if (image != null) {
        ...
        // Notificar al StatefulBuilder para actualizar la UI
        // Esto se manejará dentro del StatefulBuilder
      }
    }
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(height: 4),
                                      Text(
                                        '₡${(loan.amount * (1 - loan.progress)).toInt()}',
                                        style: TextStyle(
                                          fontSize: 18,
                                          fontWeight: FontWeight.w700,
                                          color:
                                ...
                                onPressed:
                                    _isUploading
                                        ...
                                        : () async {
                                          ...
                                          // Actualizar el progreso del préstamo localmente
